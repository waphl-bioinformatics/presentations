...
<img src="media/hai_gb_mermaid_3.svg" alt="Bacteria Overview">

- Pipeline
- TB is our only clinically validated pipeline and is processed separately from other bacterial species


## Phoenix vs TheiaProk
<img src="media/phoenix_vs_theiaprok_1.svg" alt="Bacteria Overview">


## Bacterial Dataflow
<img src="media/binfx_data_workflow.svg" alt="Bacteria Dataflow">
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td colspan="3" style="text-align: left;">1-2 business days***</td>
    </tr>
    <tr>
      <td><strong>Compute Resources</strong></td>
      <td>AWS + Seqera</td>
      <td>Terra.bio + Google Cloud</td>
      <td>AWS + Seqera</td>
    </tr>
  </tbody>
</table>
...
- [**TheiaProk](https://github.com/theiagen/public_health_bioinformatics/blob/main/workflows/theiaprok/wf_theiaprok_illumina_pe.wdl)
