---
title: "Genomic Surveillance of Hospital-Associated Bacterial and Fungal Infections at the Washington State Public Health Laboratory"
author:
  - name: Holly Halstead, MSc
  - name: Zack Mudge, MSc
  - name: Jared Johnson, PhD, MSc
...
| Metric | Sample-level | Population-level |
|:-------|:-----------------|:----------------------|
...
<img src="media/mr-example.png">

# .{ background-image="media/soap-box.png" background-size="contain"}
...
- WA PHL's only routine fungal bioinformatics workflow is for _Candidozyma auris_ WGS, for the AR Lab Network
...
<img src="media/fungal_microreact.png" alt="Fungal pipeline microreact output">

## Summary

Genomic analysis of hospital associated infections can be split into two primary analyses - **sample**-level and **population**-level - each requiring different quality control considerations!
...
- **PHoeNIx** for per-sample QC, typing, and AMR gene detection
- **BigBacter** for clustering and core-SNP phylogenies
- HAI: ~35–45 seqs 2×/month · Non-HAI: ~1–8 seqs/week
:::

::: {.column  width=49%}
#### Fungi

- Routine workflow is *Candidozyma auris* WGS only — other fungi are **ad-hoc**
- **MycoSNP** in production; **CorgiSNPs** in validation
- ~20–30 seqs 2×/month
:::
::::
...
#### Both
- **1–2 business day TAT** and prioritized by epi need.
- Interpretation is generally the bottleneck, not computational analysis

# Questions? {.center}

::: {.contact}
**Contact:** [waphl-bioinformatics@doh.wa.gov](mailto:waphl-bioinformatics@doh.wa.gov)
:::